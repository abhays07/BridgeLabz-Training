...
public class IplJsonCensor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Read IPL JSON file
        ArrayNode matches =
                (ArrayNode) mapper.readTree(new File("C:\\Users\\ronit\\Desktop\\Java Programming Workspace\\java-iostreams\\gcr-codebase\\jsonDataHandelling\\src\\com\\jsondatahandeling\\iplandcensoranalyzer\\ipl.json"));
